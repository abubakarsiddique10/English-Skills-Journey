...
const createMenuItem = (item) => {
    ...
    li.innerHTML = `
        <a class="capitalize text-base font-medium font-sans py-2 lg:py-0 rounded-md leading-5 text-[#000000cc] tracking-[-0.45px] nav-active block" aria-current="page" href="${item.link}">${item.name}
        </a>
    `;
    return li
}
